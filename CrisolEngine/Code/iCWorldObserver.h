...
//   observadoras de la entidad jugador.
///////////////////////////////////////////////////////////////////////////////
#ifndef _ICWORLDOBSERVER_H_
#define _ICWORLDOBSERVER_H_
...
// Interfaz iCWorldObserver
struct iCWorldObserver
{
public:
  // Operacion de notificacion
  virtual void WorldObserverNotify(const WorldObserverDefs::eObserverNotifyType& NotifyType,
								   const dword udParam) = 0;
}; // ~ iCWorldObserver

#endif // ~ #ifdef _ICWORLDOBSERVER_H_
